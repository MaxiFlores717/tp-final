...
public class Helper{
    ...
    public static Integer getPositiveInteger(Scanner scanner, String inputMessage) {
        ...
        while (true) {
            try {
                ...
                if (integerValue > 0) {
                    ...
                    System.out.println("Ingrese un número entero positivo valido");
                }
            }
            catch (Exception exception) {
    ...
    public static Integer getNegativeInteger(Scanner scanner, String inputMessage) {
        Integer integerValue;
        while (true) {
            try {
                System.out.print(inputMessage);
                ...
                if (integerValue < 0) {
                    ...
                    System.out.println("Ingrese un número entero negativo valido");
                }
            }
            catch (Exception exception) {
                System.out.println("Ingrese un numero entero negativo valido");
            }
        }
    }
    //endregion
...
public static Double getPositiveDouble(Scanner scanner, String inputMessage) {
        Double doubleValue;
        while (true) {
            try {
                System.out.print(inputMessage);
 ...
 public static Double getNegativeDouble(Scanner scanner, String inputMessage) {
        Double doubleValue;
        while (true) {
            try {
                System.out.print(inputMessage);
                ...
                if (doubleValue < 0) {
                    ...
                    System.out.println("Ingrese un numero negativo valido");
                }
            }
            catch (Exception exception) {
                System.out.println("Ingrese un numero negativo valido");
