...
public class Main {
                    ...
                    do {
                        ...
                        switch (opcionAuxiliar) {
                            ...
                            case 4:
                                ...
                                buscarUsuarioPorCodigo(codigoUsuario);
                                break;
                            case 5:
                    ...
                    do {
                        ...
                        switch (opcionSuplementaria) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                DoubleLinkedList<Usuario> usuariosConLibrosPrestados = listarUsuariosConLibrosPrestados(
                                        arregloUsuarios);
    ...
    public static void buscarUsuarioPorCodigo(int numUsuario) {
        System.out.println("----Busqueda de Usuarios:----");
        Usuario usuarioEncontrado = buscarUsuarioPorCodigoEnArreglo(numUsuario);

        if (usuarioEncontrado != null) {
            System.out.println("Usuario encontrado:");
            System.out.println(usuarioEncontrado.toString());
        } else {
            System.out.println("No se encontra ningun usuario con ese codigo");
        }
    }
    ...
    private static void prestamoDeLibros() {
        ...
        } else if (libro.isDisponible() == false) { // Si el libro no esta disponible el ususario se guardara en la cola
                                                    // pendientes
            pendientes.add(usuario);
            System.out.println(
                    "La operacion de de prestamo fue rechazado por que el libro solicitado no esta disponible");
        }
    ...
    // Metodo 7: Reversion de operaciones en la pila acciones(de prestamo a
    // devolucion y de devolucion a prestamo)
    ...
    private static void mostrarTodosLosUsuarios() {
        ...
        for (int i = 0; i < cantidadUsuarios; i++) {
            ...
            if (usuario != null) {
                ...
                // System.out.println(usuario.toString()); //NO CONVIENE HACER SOLAMENTE ESTA
                // LINEA?
    ...
    private static DoubleLinkedList<Usuario> listarUsuariosConLibrosPrestados(Usuario[] arregloUsuarios) {
        ...
        for (int i = 0; i < arregloUsuarios.length; i++) {
            if (arregloUsuarios[i] != null
                    && arregloUsuarios[i].getCantidadLibrosPrestados() >= cantidadLibrosPrestados) {
